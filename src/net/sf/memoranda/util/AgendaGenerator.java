...
//>>>>>>> 1.4
    ...
    static String generateStickers(CalendarDate date) {
        ...
        String iurl2 =
                net
                    ...
                    .toExternalForm();
        String s = "<hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"memoranda:addsticker\"><img align=\"left\" width=\"22\" height=\"22\" src=\""
                    + iurl
    ...
    private static PriorityQueue sortStickers(){
        ...
        for (Iterator i = stickers.keySet().iterator(); i.hasNext();) {
            ...
            pQ.insertar(new Pair(el,Integer.parseInt(el.getAttributeValue("priority"))));
        }
        return pQ;
    }
